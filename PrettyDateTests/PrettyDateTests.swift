...
class PrettyDateTests: XCTestCase {
    ...
    func testPrettifyTimeIntervalWithZeroSecondsLessThanCurrent() {
        let prettyString = PrettyDate.stringForTimeInterval(timeInterval: PrettyDateTests.timeInterval(withDifference: 0))
        XCTAssertEqual(prettyString, "Now")
    }
    
    func testPrettifyTimeIntervalWithTwentySecondsLargerThanCurrent() {
        let prettyString = PrettyDate.stringForTimeInterval(timeInterval: PrettyDateTests.timeInterval(withDifference: 20))
        XCTAssertEqual(prettyString, "Now")
    }
    ...
    func testPrettifyTimeIntervalWithThirtySecondsLargerThanCurrent() {
        let prettyString = PrettyDate.stringForTimeInterval(timeInterval: PrettyDateTests.timeInterval(withDifference: 30))
        XCTAssertEqual(prettyString, "Now")
    }
    ...
    func testPrettifyTimeIntervalWithThirtyOneSecondsLargerThanCurrent() {
        let prettyString = PrettyDate.stringForTimeInterval(timeInterval: PrettyDateTests.timeInterval(withDifference: 31.5))
    ...
    func testPrettifyTimeIntervalWithAlmostAMinuteLargerThanCurrent() {
        let prettyString = PrettyDate.stringForTimeInterval(timeInterval: PrettyDateTests.timeInterval(withDifference: 59.5))
        XCTAssertEqual(prettyString, "in a minute")
    }
    ...
    func testPrettifyTimeIntervalWithAMinuteLargerThanCurrent() {
        let prettyString = PrettyDate.stringForTimeInterval(timeInterval: PrettyDateTests.timeInterval(withDifference: 60.5))
    ...
    func testPrettifyTimeIntervalWithAMinuteAndHalfLargerThanCurrent() {
        let prettyString = PrettyDate.stringForTimeInterval(timeInterval: PrettyDateTests.timeInterval(withDifference: 90.5))
        XCTAssertEqual(prettyString, "in 1 minute")
    }
    ...
    func testPrettifyTimeIntervalWithTwoMinuteLargerThanCurrent() {
        let prettyString = PrettyDate.stringForTimeInterval(timeInterval: PrettyDateTests.timeInterval(withDifference: 120.5))
    ...
    func testPrettifyTimeIntervalWithThirtyMinuteLargerThanCurrent() {
        let prettyString = PrettyDate.stringForTimeInterval(timeInterval: PrettyDateTests.timeInterval(withDifference: 1800.5))
    ...
    func testPrettifyTimeIntervalWithFiftyNineMinuteLargerThanCurrent() {
        let prettyString = PrettyDate.stringForTimeInterval(timeInterval: PrettyDateTests.timeInterval(withDifference: 3599.5))
    ...
    func testPrettifyTimeIntervalWithOneHourLargerThanCurrent() {
        let prettyString = PrettyDate.stringForTimeInterval(timeInterval: PrettyDateTests.timeInterval(withDifference: 3600.5))
    ...
    func testPrettifyTimeIntervalWithOneHourAndHalfLargerThanCurrent() {
        let prettyString = PrettyDate.stringForTimeInterval(timeInterval: PrettyDateTests.timeInterval(withDifference: 5400.5))
        XCTAssertEqual(prettyString, "in 1 hour")
    }
    ...
    func testPrettifyTimeIntervalWithTwoHoursLargerThanCurrent() {
        let prettyString = PrettyDate.stringForTimeInterval(timeInterval: PrettyDateTests.timeInterval(withDifference: 7200.5))
    ...
    func testPrettifyTimeIntervalWithTwelveHoursLargerThanCurrent() {
        let prettyString = PrettyDate.stringForTimeInterval(timeInterval: PrettyDateTests.timeInterval(withDifference: 43200.5))
    ...
    func testPrettifyTimeIntervalWithTwentyThreeHoursLargerThanCurrent() {
        let prettyString = PrettyDate.stringForTimeInterval(timeInterval: PrettyDateTests.timeInterval(withDifference: 82800.5))
    ...
    func testPrettifyTimeIntervalWithOneDayLargerThanCurrent() {
        let prettyString = PrettyDate.stringForTimeInterval(timeInterval: PrettyDateTests.timeInterval(withDifference: 86400.5))
    ...
    func testPrettifyTimeIntervalWithOneAndHalfDayLargerThanCurrent() {
        let prettyString = PrettyDate.stringForTimeInterval(timeInterval: PrettyDateTests.timeInterval(withDifference: 129600.5))
        XCTAssertEqual(prettyString, "tomorrow")
    }
    ...
    func testPrettifyTimeIntervalWithTwoDaysLargerThanCurrent() {
        let prettyString = PrettyDate.stringForTimeInterval(timeInterval: PrettyDateTests.timeInterval(withDifference: 172800.5))
    ...
    func testPrettifyTimeIntervalWithSixDaysLargerThanCurrent() {
        let prettyString = PrettyDate.stringForTimeInterval(timeInterval: PrettyDateTests.timeInterval(withDifference: 518400.5))
        XCTAssertEqual(prettyString, "in 6 days")
    }
    
    func testPrettifyTimeIntervalWithSixDaysLessThanCurrent() {
        let prettyString = PrettyDate.stringForTimeInterval(timeInterval: PrettyDateTests.timeInterval(withDifference: -518400))
        XCTAssertEqual(prettyString, "6 days ago")
    }
    
    func testPrettifyTimeIntervalWithSevenDaysLargerThanCurrent() {
        let prettyString = PrettyDate.stringForTimeInterval(timeInterval: PrettyDateTests.timeInterval(withDifference: 604800.5))
        XCTAssertEqual(prettyString, "in 1 week")
    }
    
    func testPrettifyTimeIntervalWithSevenDaysLessThanCurrent() {
        let prettyString = PrettyDate.stringForTimeInterval(timeInterval: PrettyDateTests.timeInterval(withDifference: -604800))
        XCTAssertEqual(prettyString, "1 week ago")
    }
    
    func testPrettifyTimeIntervalWithFourWeeksLargerThanCurrent() {
        let prettyString = PrettyDate.stringForTimeInterval(timeInterval: PrettyDateTests.timeInterval(withDifference: (604800 * 4) + 0.5))
    ...
    func testPrettifyTimeIntervalWithFiveWeeksLargerThanCurrent() {
        let prettyString = PrettyDate.stringForTimeInterval(timeInterval: PrettyDateTests.timeInterval(withDifference: (604800 * 5) + 0.5))
    ...
    func testPrettifyTimeIntervalWithFiveMonthsLargerThanCurrent() {
        let prettyString = PrettyDate.stringForTimeInterval(timeInterval: PrettyDateTests.timeInterval(withDifference: ((604800 * 5) * 5) + 0.5))
